...
labelTitle=Label(topFrame,text='Hotel Name',font=('arial',30,'bold'),fg='black',bd=9,
                 bg='pink',width=51)
...
buttonSend=Button(buttonFrame,text='Send',font=('arial',14,'bold'),fg='black',bg='orange',bd=3,padx=5,command=send)
